...
class CalculateMultiFrequencyAngularPowerSpectrum(task.SingleTask):
    ...
    xromb : int, optional
        ...
        name xromb.) xromb=0 turns off this integral. Default: 2. When
        dealing with nonlinear matter power spectrum, for sub-percent
        accuracy up to l ~ 1500, xromb = 3 is recommended.
    leg_q : int, optional
        Integration accuracy parameter for Legendre transform for C_ell
        computation. Default: 4. When dealing with nonlinear matter power
        spectrum, for sub-percent accuracy up to l ~ 1500, leg_q = 16 is
        recommended.
